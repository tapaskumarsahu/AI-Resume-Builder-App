    ...
    <div className='space-y-4'>
      ...
      {data.length > 0 ? (
        ...
        <div className='text-center py-6 text-gray-500'>
          ...
          <p className='text-sm'>Added your technical and soft skills above.</p>
        </div>
      )}
      <div className='bg-blue-50 p-3 rounded-lg'>
        <p className='text-sm text-blue-800'><strong>Tip:</strong> Add 8-12 relevant skills. Include both technical skills(programming languages, frameworks, tools) and soft skills(communication, leadership, problem-solving).</p>
      </div>
    </div>
  )
}