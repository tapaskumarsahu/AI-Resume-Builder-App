...
export default function ProfessionalSummaryForm({data, onChange, setResumeData}) {
  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='mt-6'>
        <textarea onChange={(e)=>onChange(e.target.value)} value={data || ""} rows={7} className='w-full p-3 px-4 mt-2 border text-sm border-gray-300 rounded-lg focus:border-blue-500 outline-none transition-colors resize-none' placeholder='Write a compelling professional summary that highlights your key strengths and career objectives...' />
